...
export default function CompleteInfoForm() {
    ...
    //get the values from local stroge 
    ...
    return (
        <>
            {successMsg.length > 0 ? <div className='text-center p-4 my-3 w-[90%] text-gray-800 m-auto bg-emerald-400'>{successMsg}
                ...
                <form onSubmit={submitComleteInfoForm} >
                    <div className=' w-[70%] m-auto'>
                        ...
                        <div className='my-5'>
                            ...
                            > Email </label>
                            <input
                                placeholder='same email you entered in the quote form...'
                                type="text"
                                name='email'
                                onChange={getInputValue}
                                className="block w-full  p-[6px] border border-gray-300 text-gray-700 bg-white  rounded focus:border-blue-500 focus:border-2  focus:outline-none "
